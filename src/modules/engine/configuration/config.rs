...
// src/modules/engine/configuration/config.rs

use serde::{Deserialize, Serialize};
use std::{fs, io, path::PathBuf};
use toml;

pub use crate::modules::engine::configuration::animation::AnimationConfig;
pub use crate::modules::engine::configuration::env::EnvConfig;
pub use crate::modules::engine::configuration::general::GeneralConfig;
pub use crate::modules::engine::configuration::theme::ThemeConfig;
use crate::modules::engine::configuration::validate::{validate_animations, validate_theme};
...
pub fn get_config_path() -> PathBuf {
    ...
    path.push(".config/gameengine/gameengine.conf");
    path
}
